...
init()
{
	...
	registerCrateType( "supplydrop_mp", "killstreak", "radar_mp", 10, &"KILLSTREAK_RADAR_CRATE", &"PLATFORM_RADAR_GAMBLER", "MEDAL_SHARE_PACKAGE_RECON", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "counteruav_mp", 10, &"KILLSTREAK_COUNTERU2_CRATE", &"PLATFORM_COUNTERU2_GAMBLER", "MEDAL_SHARE_PACKAGE_COUNTERU2", ::giveCrateKillstreak );
	...
	registerCrateType( "supplydrop_mp", "killstreak", "m220_tow_mp", 8, &"KILLSTREAK_M220_TOW_CRATE", &"PLATFORM_M220_TOW_GAMBLER", "MEDAL_SHARE_PACKAGE_TOW", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "mortar_mp", 8, &"KILLSTREAK_MORTAR_CRATE", &"PLATFORM_MORTAR_GAMBLER", "MEDAL_SHARE_PACKAGE_MORTAR", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "autoturret_mp", 7, &"KILLSTREAK_AUTO_TURRET_CRATE", &"PLATFORM_AUTO_TURRET_GAMBLER", "MEDAL_SHARE_PACKAGE_AUTO_TURRET", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "auto_tow_mp", 6, &"KILLSTREAK_TOW_TURRET_CRATE", &"PLATFORM_TOW_TURRET_GAMBLER", "MEDAL_SHARE_PACKAGE_TOW_TURRET", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "airstrike_mp", 6, &"KILLSTREAK_AIRSTRIKE_CRATE", &"PLATFORM_AIRSTRIKE_GAMBLER", "MEDAL_SHARE_PACKAGE_AIRSTRIKE", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "m202_flash_mp", 5, &"KILLSTREAK_M202_FLASH_CRATE", &"PLATFORM_M202_FLASH_GAMBLER", "MEDAL_SHARE_PACKAGE_FLASH", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "napalm_mp", 5, &"KILLSTREAK_NAPALM_CRATE", &"PLATFORM_NAPALM_GAMBLER", "MEDAL_SHARE_PACKAGE_NAPALM", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "radardirection_mp", 5, &"KILLSTREAK_SATELLITE_CRATE", &"PLATFORM_SATELLITE_GAMBLER", "MEDAL_SHARE_PACKAGE_SATELLITE", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "helicopter_comlink_mp", 5, &"KILLSTREAK_HELICOPTER_CRATE", &"PLATFORM_HELICOPTER_GAMBLER", "MEDAL_SHARE_PACKAGE_HELICOPTER_COMLINK", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "minigun_mp", 4, &"KILLSTREAK_MINIGUN_CRATE", &"PLATFORM_MINIGUN_GAMBLER", "MEDAL_SHARE_PACKAGE_MINIGUN", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "helicopter_gunner_mp", 3, &"KILLSTREAK_HELICOPTER_GUNNER_CRATE", &"PLATFORM_HELICOPTER_GUNNER_GAMBLER", "MEDAL_SHARE_PACKAGE_HELICOPTER_GUNNER", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "dogs_mp", 2, &"KILLSTREAK_DOGS_CRATE", &"PLATFORM_DOGS_GAMBLER", "MEDAL_SHARE_PACKAGE_DOGS", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "helicopter_player_firstperson_mp", 2, &"KILLSTREAK_HELICOPTER_PLAYER_CRATE", &"PLATFORM_HELICOPTER_PLAYER_GAMBLER", "MEDAL_SHARE_PACKAGE_HELICOPTER_PLAYER", ::giveCrateKillstreak );
	...
	registerCrateType( "gambler_mp", "killstreak", "airstrike_mp", 7, &"KILLSTREAK_AIRSTRIKE_CRATE", undefined, "MEDAL_SHARE_PACKAGE_AIRSTRIKE", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "m202_flash_mp", 6, &"KILLSTREAK_M202_FLASH_CRATE", undefined, "MEDAL_SHARE_PACKAGE_FLASH", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "napalm_mp", 5, &"KILLSTREAK_NAPALM_CRATE", undefined, "MEDAL_SHARE_PACKAGE_NAPALM", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "radardirection_mp", 5, &"KILLSTREAK_SATELLITE_CRATE", undefined, "MEDAL_SHARE_PACKAGE_SATELLITE", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "helicopter_comlink_mp", 5, &"KILLSTREAK_HELICOPTER_CRATE", undefined, "MEDAL_SHARE_PACKAGE_HELICOPTER_COMLINK", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "minigun_mp", 4, &"KILLSTREAK_MINIGUN_CRATE", undefined, "MEDAL_SHARE_PACKAGE_MINIGUN", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "helicopter_gunner_mp", 4, &"KILLSTREAK_HELICOPTER_GUNNER_CRATE", undefined, "MEDAL_SHARE_PACKAGE_HELICOPTER_GUNNER", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "dogs_mp", 2, &"KILLSTREAK_DOGS_CRATE", undefined, "MEDAL_SHARE_PACKAGE_DOGS", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "helicopter_player_firstperson_mp", 2, &"KILLSTREAK_HELICOPTER_PLAYER_CRATE", undefined, "MEDAL_SHARE_PACKAGE_HELICOPTER_PLAYER", ::giveCrateKillstreak );
