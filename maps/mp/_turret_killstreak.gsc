...
//		maps\mp\gametypes\_hardpoints::setRemoveWeaponWhenUsed("autoturret_mp", true);
...
useSentryTurret( hardpointType )
{
	...
	//self maps\mp\gametypes\_hardpoints::printKillstreakStartText( hardpointType, self, self.team );
